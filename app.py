...
try:
    ...
    st.error("Could not find 'database.py'. Please ensure it's in the PESU RESUM directory.")
    st.stop()
...
if not st.session_state['logged_in']:
    st.title("Welcome to PESU RESUMATE 🌐")
